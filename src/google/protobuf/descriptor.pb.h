...
class PROTOBUF_EXPORT FieldOptions final :
 ...
 public:
  ...
  void clear_target() ;
  public:
  ::PROTOBUF_NAMESPACE_ID::FieldOptions_OptionTargetType target(int index) const;
  void set_target(int index, ::PROTOBUF_NAMESPACE_ID::FieldOptions_OptionTargetType value);
  void add_target(::PROTOBUF_NAMESPACE_ID::FieldOptions_OptionTargetType value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>& target() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>* mutable_target();

  private:
  ::PROTOBUF_NAMESPACE_ID::FieldOptions_OptionTargetType _internal_target(int index) const;
  void _internal_add_target(::PROTOBUF_NAMESPACE_ID::FieldOptions_OptionTargetType value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>* _internal_mutable_target();
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedField<int> target_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::PROTOBUF_NAMESPACE_ID::UninterpretedOption > uninterpreted_option_;
    int ctype_;
    int jstype_;
    bool packed_;
...
// repeated .google.protobuf.FieldOptions.OptionTargetType target = 18;
inline int FieldOptions::_internal_target_size() const {
  return _impl_.target_.size();
}
inline int FieldOptions::target_size() const {
  return _internal_target_size();
}
inline void FieldOptions::clear_target() {
  _impl_.target_.Clear();
}
inline ::PROTOBUF_NAMESPACE_ID::FieldOptions_OptionTargetType FieldOptions::target(int index) const {
  // @@protoc_insertion_point(field_get:google.protobuf.FieldOptions.target)
  return _internal_target(index);
}
inline void FieldOptions::set_target(int index, ::PROTOBUF_NAMESPACE_ID::FieldOptions_OptionTargetType value) {
  assert(::PROTOBUF_NAMESPACE_ID::FieldOptions_OptionTargetType_IsValid(value));
  _impl_.target_.Set(index, value);
  // @@protoc_insertion_point(field_set:google.protobuf.FieldOptions.target)
}
inline void FieldOptions::add_target(::PROTOBUF_NAMESPACE_ID::FieldOptions_OptionTargetType value) {
  _internal_add_target(value);
  // @@protoc_insertion_point(field_add:google.protobuf.FieldOptions.target)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>& FieldOptions::target() const {
  // @@protoc_insertion_point(field_list:google.protobuf.FieldOptions.target)
  return _impl_.target_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>* FieldOptions::mutable_target() {
  // @@protoc_insertion_point(field_mutable_list:google.protobuf.FieldOptions.target)
  return _internal_mutable_target();
}
inline ::PROTOBUF_NAMESPACE_ID::FieldOptions_OptionTargetType FieldOptions::_internal_target(int index) const {
  return static_cast<::PROTOBUF_NAMESPACE_ID::FieldOptions_OptionTargetType>(_impl_.target_.Get(index));
}
inline void FieldOptions::_internal_add_target(::PROTOBUF_NAMESPACE_ID::FieldOptions_OptionTargetType value) {
  assert(::PROTOBUF_NAMESPACE_ID::FieldOptions_OptionTargetType_IsValid(value));
  _impl_.target_.Add(value);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>* FieldOptions::_internal_mutable_target() {
  return &_impl_.target_;
}
